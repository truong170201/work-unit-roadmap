    ...
    def test_start_contract_creates_one_file_execution_contract(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "executor may edit only the active phase contract's `## Execution Rounds And Reports` section",
                "must not edit the phase contract header, Goal, Success Criteria, Pending Work table, Allowed Read References, or any other contract file",
    ...
    def test_contract_model_replaces_worktree_sync_and_codex_delegation(self) -> None:
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "Executors may edit only the active phase contract's `## Execution Rounds And Reports` section",
                "Executor reports must include lifecycle evidence for every touched WU",
                "Executor status suggestions stop at `active`, `ready-for-review`, `blocked`, or `deferred`",
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "may edit only the active contract's `## Execution Rounds And Reports` section",
                ...
                "If implementation requires editing project files, it creates or reuses a sparse worktree",
                "including WU lifecycle evidence and status suggestions",
                "executors do not mark WUs `accepted` or `done`",
                "`agents/reports/` stores durable WUR reports and summaries",
                "research synthesis, verification, audits, receive summaries, completion reports, archives",
                "Allowed Read References",
        ...
        self.assert_contains_all(
            ...
            [
                ...
                "Executors may edit only that section of the active phase contract",
